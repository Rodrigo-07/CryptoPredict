...
def predict_gru(next_days, coin, model_path='D:/Repos/CryptoPredict/src/Modelo/model_new_feat_gru.h5'):
    ...
    create_log(acao='Previsão', typo='GRU', timestamp=pd.to_datetime('today'))
